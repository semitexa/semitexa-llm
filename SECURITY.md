...
- **GitHub Security Advisories** — [open a private report](https://github.com/semitexa/semitexa-llm/security/advisories/new).
...
In scope: anything in `semitexa/llm` that lets a request, a job or a message do
